...
API_ID = int(getenv("API_ID", "14675318"))
API_HASH = getenv("API_HASH", "2aef8a6fdc094dc8f4ff83b1f27f4830")

## Get it from @Botfather in Telegram.
BOT_TOKEN = getenv("BOT_TOKEN", "5664340201:AAEByI1Z7JB2huYo-C4r0a7x-xRu1hrVNtI")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "- 1001728980158"))
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "5434102966").split())
